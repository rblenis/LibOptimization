...
Namespace Optimization.DerivativeFree.ParticleSwarmOptmization
    ''' <summary>
    ''' Particle Swarm Optimization using Chaotic inertia weight(using Charotic Random Inertia Weight)
    ''' </summary>
    ''' <remarks>
    ''' Features:
    ...
    ''' </remarks>
    Public Class CRIWPSO : Inherits absOptimization
#Region "Member"
...
#Region "Public"
        ...
        Public Overrides Function DoIteration(Optional ai_iteration As Integer = 0) As Boolean
            ...
            For iterate As Integer = 0 To count - 1
                ...
                'Inertia Weight Strategie :  CRIW is Chaotic Random Inertia Weight
                Dim randVal = Random.NextDouble()
                Dim u = 4.0
                Dim z = u * randVal * (1 - randVal)
                Me.Weight = 0.5 * Random.NextDouble() + 0.5 * z
            Next
